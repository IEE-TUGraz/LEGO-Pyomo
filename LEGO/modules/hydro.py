...
def add_element_definitions_and_bounds(lego: LEGO):  # TODO: Adapt to Hydro
    # Sets
    ...
    # Variables
    # Your variable as example
    lego.model.vProduction = pyo.Var(lego.model.ror, lego.model.rp, lego.model.k, doc="Production of RoR-Plant [m3/h]", bounds=(0, None))
    for rp in lego.model.rp:
        for k in lego.model.k:
            for g in lego.model.ror:
                lego.model.vProduction[rp, k, g].setub(max(lego.model.pInflow[g, rp, k], lego.model.pMaxProd[g]))
...
def add_constraints(lego: LEGO):  # TODO: Adapt to Hydro
    # Constraint definitions
    lego.model.eRoRPowerGeneration = pyo.Constraint(lego.model.ror, lego.model.rp, lego.model.k, doc='RoR power generation constraint', rule=lambda model, g, rp, k: model.vGenP[rp, k, g] == model.vProduction[rp, k, g] * model.pRatio[g])
